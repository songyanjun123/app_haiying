...
import 'rxjs/Rx';
/* 路由 */
import { Router, NavigationExtras,Params ,ActivatedRoute,NavigationStart,NavigationEnd } from "@angular/router";
import { FormGroup, FormControl, Validators }   from '@angular/forms';
import { AccountService } from '../app.service';  //引用service模块
import * as $ from 'jquery';
@Component({
  selector: 'app-news-detail-tui',
  templateUrl: './news-detail-tui.component.html',
  styleUrls: ['./news-detail-tui.component.less']
})
export class NewsDetailTuiComponent implements OnInit {
